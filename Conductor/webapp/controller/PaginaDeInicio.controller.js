sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.conductor.controller.PaginaDeInicio", {
		...
		_onRatingIndicatorChange: function(oEvent) {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("PaginaDeInicio").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
