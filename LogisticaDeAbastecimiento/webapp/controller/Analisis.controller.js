sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.logisticaDeAbastecimiento.controller.Analisis", {
		handleRouteMatched: function(oEvent) {
			var sAppId = "App636be7e31f8cf265e51c2500";
		...
		_onButtonPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("InformacionTrayecto", oBindingContext, fnResolve, "");
		...
		_onButtonPress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("Conductores", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("Analisis").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_AnalyticalListPage_AnalyticalListPage_0-analyticalheader-Fiori_AnalyticalListPage_AnalyticalHeader-1-visualfilters-Fiori_AnalyticalListPage_VisualFilterBar-1-filters-Fiori_AnalyticalListPage_VisualFilterItemBarChart-1---5",
				"groups": ["bars"]
			}, {
				"controlId": "Fiori_AnalyticalListPage_AnalyticalListPage_0-analyticalheader-Fiori_AnalyticalListPage_AnalyticalHeader-1-visualfilters-Fiori_AnalyticalListPage_VisualFilterBar-1-filters-Fiori_AnalyticalListPage_VisualFilterItemDonutChart-2---5",
				"groups": ["segments"]
			}, {
				"controlId": "Fiori_AnalyticalListPage_AnalyticalListPage_0-analyticalheader-Fiori_AnalyticalListPage_AnalyticalHeader-1-visualfilters-Fiori_AnalyticalListPage_VisualFilterBar-1-filters-Fiori_AnalyticalListPage_VisualFilterItemLineChart-3---5",
				"groups": ["points"]
			}];
		...
		onAfterRendering: function() {
			...
			oView.getModel(undefined).getMetaModel().loaded().then(function() {
				...
				var oParameters = oBindingParameters['Fiori_AnalyticalListPage_AnalyticalListPage_0-content-Fiori_AnalyticalListPage_Content-1-chartcontent-Fiori_AnalyticalListPage_ChartContainer-1-charts-sap_chart_ColumnChart-1'];
